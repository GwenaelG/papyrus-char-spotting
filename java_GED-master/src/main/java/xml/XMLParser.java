...
//			g.setFullId(g.getClassName().trim() + "|" + idx + "|" + child.getAttribute("file", null));
//			graphSet.add(g);
//			idx++;
//		}
//		return graphSet;
...
//		}
//
//		// DONE The sigma attribute of normalized graph
//		enumerator = root.enumerateChildren();
//		while (enumerator.hasMoreElements()) {
//			XMLElement child = (XMLElement) enumerator.nextElement();
//			if (child.getName().equals("attr")) {
//				String key = (String) child.getAttribute("name", null);
//				Vector children1 = child.getChildren();
//				XMLElement child1 = (XMLElement) children1.get(0);
//				String value = child1.getContent();
//				graph1.put(key, value);
//
//			}
//		}
//
