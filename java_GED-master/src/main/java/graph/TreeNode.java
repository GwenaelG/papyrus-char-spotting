...
public class TreeNode implements Comparable<TreeNode> {
	 ...
	 * @param factor
	 */
	public TreeNode(Graph g1, Graph g2, CostFunctionManager cf, double factor) {
...
//						if (tn.a2[endIndex][end2Index] != null) {
	...
	public boolean allNodesUsed() {
		return unusedNodes1.isEmpty() && unusedNodes2.isEmpty();
	}
	...
	public CostFunctionManager getCf() {
		return cf;
	}
