 ...
 * Time: 14:32
 */
public class GMPropertyCSVSimple_02_3ver {
    ...
    public static void main(String[] args) {
        ...
        String parameterFile        = "test/papyrus/settings/Parameters_cont_pap_test.csv";
        String graphFile            = "test/papyrus/settings/Graphs_cont_pap_test.csv";
        String resultPath           = "test/papyrus/results/test_02_3versions/";
        String propertyPath         = "test/papyrus/properties/test_02_3versions/";
        String sourceImagesPath     = "C:/Users/Gwenael/Desktop/MT/papyrus-char-spotting/files/original_bin/chars/";
        String targetImagesPath     = "C:/Users/Gwenael/Desktop/MT/papyrus-char-spotting/files/original_bin/XXXXXXX_pages/";
        String distVisFolder        = "C:/Users/Gwenael/Desktop/MT/papyrus-char-spotting/files/vis/hotmap/";
        String charVisFolder        = "C:/Users/Gwenael/Desktop/MT/papyrus-char-spotting/files/vis/char/papyrus/test_02_3ver/";
        String[] windowSizes        = new String[]{"1"};
        String[] thresholdValues    = new String[]{"-2", "-1.8", "-1.6", "-1.4", "-1.2", "-1", "-0.8", "-0.6", "-0.4", "-0.2"};
        String nodeRatio            = "2";
        String iouRatio             = "0.75";
