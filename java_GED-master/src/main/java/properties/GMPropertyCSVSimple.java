...
public class GMPropertyCSVSimple {
    ...
    public static void main(String[] args) {
        ...
        String parameterFile        = "test/papyrus/settings/ParametersS_cont2.csv";
        String graphFile            = "test/papyrus/settings/Graphs_cont.csv";
        String resultPath           = "test/papyrus/results/recons_bold/cont/step2/";
        String propertyPath         = "test/papyrus/properties/recons_bold/cont/step2/";
        ...
        String charVisFolder        = "C:/Users/Gwenael/Desktop/MT/papyrus-char-spotting/files/vis/char/recons_bold/cont/step2/";
