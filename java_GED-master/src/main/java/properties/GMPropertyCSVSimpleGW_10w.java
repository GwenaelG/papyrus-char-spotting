 ...
 * Time: 14:32
 */
public class GMPropertyCSVSimpleGW_10w {

    private static int nrOfCores = 1;

    private static final String GROUND_TRUTH    = "test/papyrus/groundtruth_gw.txt";
    private static final String MATCHING        = "HED";
    private static final String TREC_EVAL       = "treceval/trec_eval.exe";

    public static void main(String[] args) {

        String parameterFile    = "test/papyrus/settings/Parameters_cont_gw_test.csv";
        String graphFile        = "test/papyrus/settings/Graphs_cont_gw_test10w.csv";
        String resultPath       = "test/papyrus/results/gw/cont/test10w/";
        String propertyPath     = "test/papyrus/properties/gw/cont/test10w/";
        ...
        String charVisFolder    = "C:/Users/Gwenael/Desktop/MT/papyrus-char-spotting/files/vis/char/gw/test10w/";
