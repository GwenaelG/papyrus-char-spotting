...
public class BP2cfull {
	...
	public double getEditDistance(Graph g1, Graph g2, CostFunctionManager cf) {
		...
		map12 = new int[num1]; 
		map21 = new int[num2];
		MatrixGenerator matrixGenerator = new MatrixGenerator(cf, 0);
		matrixGenerator.setFullLocalEdgeCosts();
		nf = matrixGenerator.getSmallMatrix(g1, g2);
